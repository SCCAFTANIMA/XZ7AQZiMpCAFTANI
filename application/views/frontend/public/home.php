...
<!--div class="container main-container headerOffset globalPaddingBottom overflowyHome"--> 
  ...
  <div class=" image-show-case-wrapper center-block relative col-lg-12">
    <div id="imageShowCase" class="owl-carousel owl-theme">
      <div class="product-slide">
        ...
        <a href="#"><img class="img-responsive" src="template/images/slider/single-img/1.jpg" alt="img"></a> </div>
      <!-- /.product-slide  -->
      ...
      <div class="product-slide">
        ...
        <a href="#"><img class="img-responsive" src="template/images/slider/single-img/2.jpg" alt="img"></a> </div>
      <!-- /.product-slide  -->
      ...
      <div class="product-slide">
        ...
        <a href="#"><img class="img-responsive" src="template/images/slider/single-img/3.jpg" alt="img"></a> </div>
      <!-- /.product-slide  --> 
    </div>
    <!--/#imageShowCase -->
    ...
    <a id="ps-next" class="ps-nav"> 
        <img src="template/images/site/arrow-right.png" alt="N E X T"> </a> <a id="ps-prev" class="ps-nav"> 
        <img src="template/images/site/arrow-left.png" alt="P R E V"></a> </div>
      ...
      <div class="col-md-4 col-sm-6 col-xs-6 col-xs-min-12">
        <div class="inner">
          ...
          <a class="img-block" href="#"> 
              <img class="img-responsive" src="template/images/look3/2.jpg" alt="img"></a></div>
      </div>
      <div class="col-md-4 col-sm-6 col-xs-6 col-xs-min-12">
        <div class="inner">
          <div class="box-content-overly box-content-overly-white">
          ...
          <a class="img-block" href="#"> 
              <img class="img-responsive" src="template/images/look3/1.jpg" alt="img"></a></div>
      </div>
      <div class="col-md-4 col-sm-6 col-xs-6 col-xs-min-12">
        <div class="inner">
          <div class="box-content-overly box-content-overly-white">
          ...
          <a class="img-block" href="#"> <img class="img-responsive" src="template/images/look3/3.jpg" alt="img"></a></div>
      </div>
      <div class="col-md-4 col-sm-6 col-xs-6 col-xs-min-12">
        <div class="inner">
          <div class="box-content-overly box-content-overly-white">
          ...
          <a class="img-block" href="#"> <img class="img-responsive" src="template/images/look3/4.jpg" alt="img"></a></div>
      </div>
      <div class="col-md-4 col-sm-6 col-xs-6 col-xs-min-12">
        <div class="inner">
          <div class="box-content-overly box-content-overly-white">
          ...
          <a class="img-block" href="#"> <img  class="img-responsive" src="template/images/look3/5.jpg" alt="img"></a></div>
      </div>
      <div class="col-md-4 col-sm-6 col-xs-6 col-xs-min-12">
        <div class="inner">
          <div class="box-content-overly box-content-overly-white">
          ...
          <a class="img-block" href="#"> <img class="img-responsive" src="template/images/look3/6.jpg" alt="img"></a></div>
      </div>
    </div>
    <!--/.featuredImageLook3--> 
  </div>
...
<div class="container main-container"> 
  ...
  <div class="morePost row featuredPostContainer  " >
    <div class="col-lg-12">
      ...
      <div class="row xsResponse">
        ...
        <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
          ...
          <i class="glyphicon glyphicon-heart"></i>
            ...
            <div class="image"> <a href="product-details.html"><img src="template/images/product/31.jpg" alt="img" class="img-responsive"></a>
        ...
        <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
          ...
          <i class="glyphicon glyphicon-heart"></i>
            ...
            <div class="image"> <a href="product-details.html"><img src="template/images/product/34.jpg" alt="img" class="img-responsive"></a>
        ...
        <div class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
          ...
          <i class="glyphicon glyphicon-heart"></i>
            ...
            <div class="image"> <a href="product-details.html"><img src="template/images/product/35.jpg" alt="img" class="img-responsive"></a> </div>
            <div class="description">
  ...
  <div class="width100 section-block  text-center">
    <div class="row featuredImgLook2">
      <div class="col-md-3 col-sm-6 col-xs-6">
        <div class="inner" style="height: 414px;"> <a href="category.html" class="img-link"><img alt="img" class="img-responsive" src="template/images/featured/1.jpg"></a>
      ...
      <div class="col-md-3 col-sm-6 col-xs-6">
        <div class="inner" style="height: 414px;"> <a href="category.html" class="img-link"><img alt="img" class="img-responsive" src="template/images/featured/2.jpg"></a>
          <h3><span> Summer 2014 </span> demonstraverunt lectores </h3>
          <p>We are very pleased to announce the availability of many new emerging designers</p>
          <a class="btn btn-link"> See More <i class="fa fa-long-arrow-right"></i> </a> </div>
      </div>
      <div class="col-md-3 col-sm-6 col-xs-6">
        <div class="inner" style="height: 414px;"> <a href="category.html" class="img-link"><img alt="img" class="img-responsive" src="images/featured/3.jpg"></a>
          <h3> <span> Latest Offers </span> demonstraverunt lectores </h3>
          <p>We are very pleased to announce the availability of many new emerging designers</p>
          <a class="btn btn-link"> See More <i class="fa fa-long-arrow-right"></i> </a> </div>
      </div>
      <div class="col-md-3 col-sm-6 col-xs-6">
        <div class="inner" style="height: 414px;"> <a href="category.html" class="img-link">
                <img alt="img" class="img-responsive" src="template/images/featured/4.jpg"></a>
